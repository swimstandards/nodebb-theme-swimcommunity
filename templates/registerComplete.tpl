...
<form class="form-narrow" role="form" method="post" action="{config.relative_path}/register/complete"
	...
	<div class="row mt-3">
		<div class="col-12 col-sm-8 offset-sm-2 d-grid">
			...
			<button class="btn btn-link"
				formaction="{config.relative_path}/register/abort">{{{ if register }}}[[register:cancel-registration]]{{{ else }}}[[modules:bootbox.cancel]]{{{ end }}}</button>
		</div>
	</div>
</form>